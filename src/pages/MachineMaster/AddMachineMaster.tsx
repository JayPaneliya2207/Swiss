...
const AddMachineMaster: React.FC = () => {
  const [selectedOption, setSelectedOption] = useState<string>('');

  return (
    <div>
      <Breadcrumb pageName="Add Machine Master" />
          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <form className="grid grid-cols-12 gap-4 p-6">
              ...
              <div className="col-span-12">
                <button
                  type="submit"
                  className="w-full rounded bg-primary py-3 px-6 text-white transition hover:bg-opacity-90 focus:outline-none"
                >
                  Save
                </button>
              </div>
