...
const FranchisePurchase: React.FC = () => {
  ...
  const handleEditClick = (id: number) => {
    navigate(`/franchise/franchise-purchase/view-franchise-purchase/${id}`);
  };

  return (
    <>
      <Breadcrumb pageName="Franchise Purchase" />
      <div
...
export default FranchisePurchase;
