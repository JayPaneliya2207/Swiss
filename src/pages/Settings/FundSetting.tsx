...
const FundSetting: React.FC = () => {
  ...
  return (
    <>
      <Breadcrumb pageName="Fund Setting" />
              ...
              {packageData.length ? (
                packageData.map((packageItem) => (
                  <tr key={packageItem.id}>
                    ...
                    <td className="border-b border-[#eee] py-5 px-2 dark:border-strokedark">
                      {packageItem.name === 'Fund Transfer with OTP' ||
                      packageItem.name === 'Admin transfer with OTP' ? (
                        <div>
                          <SwitcherOne />
